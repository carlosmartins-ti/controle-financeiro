...
# TESTE DE VIDA DO APP (não remove nada, apenas ajuda debug)
st.write("")
...
def screen_app():
    ...
    budget = repos.get_budget(st.session_state.user_id, month, year) or {
        "income": 0,
        "expense_goal": 0
    }
    ...
    if page == "🧾 Despesas":
        ...
        st.info("Todas as funções originais (marcar como paga, desfazer, editar) estão preservadas.")
